              ...
              child: Column(
                ...
                children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text("Partner code: $partnerCode", style: const TextStyle(fontSize: 16)),
                            const Text("Couple: —", style: TextStyle(fontSize: 16)), // Placeholder
                          ],
                        ),
                      ),
                    ],
                  ...
                  const Align(
                    ...
                    child: Text("Made by @lynx_argon_op"),
                  ),
                ],
              ),
            ),
